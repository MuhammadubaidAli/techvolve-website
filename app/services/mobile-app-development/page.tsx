...
export default function MobileAppDevelopmentPage() {
  const services = [
    ...
    },
    {
      ...
      description: "Native iOS apps for iPhone and iPad with seamless integration",
      icon: Smartphone,
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              ...
              user experiences that engage and delight your users.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900/50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              We create mobile applications that not only look great but also perform exceptionally across all devices.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Built specifically for each platform to ensure optimal performance and user experience",
              },
              {
              ...
              },
              {
                ...
                description: "Future-proof applications that can grow with your business needs",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
